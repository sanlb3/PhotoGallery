...
class PreferencesRepository(
    ...
    val storedQuery: kotlinx.coroutines.flow.Flow<String> = dataStore.data.map {
        it[SEARCH_QUERY_KEY] ?: ""
    ...
    val lastResultId: kotlinx.coroutines.flow.Flow<String> = dataStore.data.map {
    ...
    val isPolling: kotlinx.coroutines.flow.Flow<Boolean> = dataStore.data.map {
